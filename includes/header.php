<!--header-->
<div class="header" id="home" style="padding-bottom: 70px;">
    <nav class="navbar navbar-default">
        <div class="container" style="padding-bottom: 30px; backgrd-color:#333;">
            ...
            <div class="navbar-header">
                ...
                <h1><a class="navbar-brand" href="index.php">KSSSMB</a></h1>
            </div>
