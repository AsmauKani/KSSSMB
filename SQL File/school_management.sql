...
INSERT INTO `tblsaff` (`ID`, `StaffName`, `StaffEmail`, `Gender`, `DOB`, `StaffID`, `FatherName`, `MotherName`, `ContactNumber`, `AltenateNumber`, `Address`, `UserName`, `Password`, `Image`, `DateofAdmission`) VALUES
